class Messages
  ...
  def message_computer_hit(coordinate)
    "Incoming fire at #{coordinate}.... Your opponent has scored a direct hit."
  end

  def message_computer_miss(coordinate)
  ...
  def prompt_player_to_end_turn
    "Press ENTER to end your turn."
  end

  def computer_map_message
    "Here is your opponent's progress:"
  end

  def player_map_message
    "Here is your progress:"
  end

  def hit_no_sink_message
    "The hit did not sink the ship."
  end

  def hit_sink_message(ship_type)
  ...
  def game_clock_message(time_string)
