...
class MessagesTest < Minitest::Test
  ...
  def test_welcome
    ...
    assert_equal "Welcome to BATTLESHIP", welcome #welcome
  end

  def test_prompt_to_play
    assert_equal "Would you like to (p)lay, read the (i)nstructions, or (q)uit?", prompt_to_play
  end
  ...
  def test_prompt_to_place_ship
    ...
    assert_equal actual, prompt_place_ship(2)
  end

  def test_prompt_player_for_firing_coordinates
    actual = "Enter firing coordinates:"
    assert_equal actual, prompt_player_for_firing_coordinates
  end
  ...
  def test_error_invalid_coordinate
    ...
    assert_equal actual, error_invalid_coordinate
  end
  ...
  def test_error_previously_attacked_coordinate
    ...
    assert_equal actual, error_previously_attacked_coordinate
  end

  def test_message_hit
    actual = "You have hit an enemy ship."
    assert_equal actual, message_hit[-27..-1]
  end

  def test_message_miss
    actual = "You did not hit an enemy ship."
    assert_equal actual, message_miss[-30..-1]
  end
  ...
  def test_message_computer_hit
    ...
    assert_equal actual, message_computer_hit("A1")
    assert_equal actual2, message_computer_hit("B2")
  end
